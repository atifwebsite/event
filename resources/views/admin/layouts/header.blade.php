...
<head>
    ...
    <link rel="stylesheet"
        href="{{ url('assests/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}">
    <!-- iCheck -->
    ...
    <!-- summernote -->
    <link rel="stylesheet" href="{{ url('assests/plugins/summernote/summernote-bs4.min.css') }}">
    @notifyCss
</head>
